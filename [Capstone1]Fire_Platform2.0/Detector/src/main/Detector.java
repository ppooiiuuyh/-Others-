    ...
    public static void main(String[] argv){
        ...
        while (true) {
            ...
            //화재 감지
                ...
                if(!sendImg_toGate_TCP.isAlive()) {
                    sendImg_toGate_TCP = new MyIntervaledThread(new ToGate_IMG_TCP("222.222.0.100", 54321),5000);
       ...
       /* MyIntervaledThread sendImg_toGate_TCP = new MyIntervaledThread();
        ...
        while(true){
            ...
            if(true) {
                if(!sendImg_toGate_TCP.isAlive()) {
                    sendImg_toGate_TCP = new MyIntervaledThread(new ToGate_IMG_TCP("182.168.0.4", 54321),5000);
                    sendImg_toGate_TCP.start();
                }
