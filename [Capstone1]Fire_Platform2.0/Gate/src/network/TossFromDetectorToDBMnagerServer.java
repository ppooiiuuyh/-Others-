            ...
            * *******************************************************/
             ...
             * *******************************************************/
                 ...
                 ************************************************/
                    ...
                    System.out.println("수신 내용 처리 완료");
...
*/
             ...
             //  sendPostToDBInterfaceServer("http://182.168.0.4:8080/myapp/todbserver.do",finalSendBytes);
             //     sendPostToDBInterfaceServer("http://ec2-13-112-225-91.ap-northeast-1.compute.amazonaws.com:8080/DBInterfaceServer/todbserver.do",finalSendBytes);
            sendPostToDBInterfaceServer("http://13.112.225.91:8080/DBInterfaceServer/todbserver.do",finalSendBytes);
            System.out.println("파일서버로 송신 완료");
    ...
    private void sendPostToDBInterfaceServer(String url,byte[] finalbytes) throws Exception {


        //String url = "http://127.0.0.1:8080/myapp/todbserver.do";
        URL obj = new URL(url);
       ...
       // String urlParameters = "sn=C02G841&6DRJM&cn=&locale=&caller=333&num=1231231453123232132132133131afasasfasf2321312";
      ...
      //  System.out.println("Post parameters : " + new String(finalbytes));
        ...
        * ******************************************************************************/
         ...
         * ******************************************************************************/
            ...
            public byte[] getLocalMacAddress() throws IOException {
                ...
                byte[] hexMac = NetworkInterface.getByName("wlan0").getHardwareAddress(); //window에서는 wlan0가 없다? there is no wlan0 interface in the window os?
