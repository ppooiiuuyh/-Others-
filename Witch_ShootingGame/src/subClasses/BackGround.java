...
public class BackGround extends Effect {
	...
	*//////////////////////////////////////////////////////////////////////
	...
	public void init() {
		...
		imgStore = new Image[] { Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("backgroundBlack.png")),
				     Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("backgroundBlack.png"))};
