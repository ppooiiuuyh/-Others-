...
import gameSystem.Interface_Lobby;
import gameSystem.Menu_LobbyScene;
...
import subClasses.BackGround_Lobby;
...
public class LobbyScene extends GameScene{
	...
	public LobbyScene(GameManager gameManager) {
	...
	public void init() {
		...
		*//////////////////////////////////////////////////////
		...
		bg = new BackGround_Lobby(this);
		c = new Character(this);
		menu = new Menu_LobbyScene(this,gm);
		s = new Sound(getClass().getClassLoader().getResource("lobby.wav"),-1);
		
		
		hi= new Interface_Hp(this,c);
		ib= new Interface_Lobby(this,c);
