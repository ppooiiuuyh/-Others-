...
public class Menu_BattleScene extends JPanel{
	...
	Image returnToLobbyDeactive;
	Image returnToLobbyActive;
	Image returnToLobby;
	int rtlx,rtly;
	int rtlw,rtlh;
	...
	///////////////////////////////메서드///////////////////////////////////////
	////////////////////////// construct///////////////////////////////////////
	public Menu_BattleScene(GameScene gameScene, GameManager gameManager)
	{
		gc = gameScene;
		gm = gameManager;
		init();
	...
	public void initComponents(){
		/////////////////////init glass/////////////////////////////////
		glass = gc.getImgBox().menu_battleScene_glass;
		...
		returnToLobbyDeactive = gc.getImgBox().returnToLobbyDeactive;
		returnToLobbyActive =gc.getImgBox().returnToLobbyActive;
		returnToLobby = returnToLobbyDeactive;
		rtlw = 400;
		rtlh = 70;
	...
	public void paint(Image img){
		...
		g2d.drawImage(returnToLobby,rtlx,rtly,rtlw,rtlh,this);
	...
	public void process(){
		...
		if(isInRect(ms.getLocation().x,ms.getLocation().y,new Rectangle(rtlx,rtly,rtlw,rtlh)))
			returnToLobby = returnToLobbyActive;
		else
			returnToLobby = returnToLobbyDeactive;
